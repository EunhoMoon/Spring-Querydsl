...
public class QuerydslBasicTest {
    ...
    void sort() {
        ...
        assertThat(m5.getUsername()).isEqualTo("member5");
        assertThat(m6.getUsername()).isEqualTo("member6");
    ...
    void paging() {
        ...
        result.stream().forEach(m -> log.info("member={}", m));
